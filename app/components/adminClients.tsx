    ...
    <section>
      <div className="mb-6 grid grid-cols-2 gap-3 xl:grid-cols-4">
        <div className="rounded-2xl border border-amber-400/20 bg-amber-400/[0.06] p-4 sm:p-5">
          ...
          <p className="mt-3 text-3xl font-bold text-amber-300 sm:text-4xl">
            {clients.length}
          </p>
        </div>
        ...
        <div className="rounded-2xl border border-emerald-400/20 bg-emerald-500/[0.06] p-4 sm:p-5">
          ...
          <p className="mt-3 text-3xl font-bold text-emerald-300 sm:text-4xl">
            {
              clients.filter(
                (client) =>
        ...
        <div className="rounded-2xl border border-red-400/20 bg-red-500/[0.06] p-4 sm:p-5">
          ...
          <p className="mt-3 text-3xl font-bold text-red-300 sm:text-4xl">
            {
              clients.filter(
                (client) =>
                  client.status === "blocked"
        ...
        <div className="rounded-2xl border border-blue-400/20 bg-blue-500/[0.06] p-4 sm:p-5">
          <p className="text-[10px] font-semibold uppercase tracking-[0.15em] text-slate-500 sm:text-xs">
            Simulaciones
          </p>

          <p className="mt-3 text-3xl font-bold text-blue-300 sm:text-4xl">
            {totalSimulations}
          </p>
        </div>
      </div>
                  ...
                  >
                    ...
                    <div className="mt-5 grid gap-3">
                      <Link
                        ...
                        className="w-full rounded-xl border border-blue-400/30 bg-blue-500/10 px-4 py-3 text-center text-sm font-semibold text-blue-300 transition hover:bg-blue-500/20"
                      >
                        Ver historial
                      </Link>

                      {isCurrentAdmin ? (
                        <div className="rounded-xl border border-amber-400/20 bg-amber-500/10 px-4 py-3 text-center text-sm font-semibold text-amber-300">
                          Cuenta protegida
                        </div>
                      ) : (
                        <button
                          ...
                          className={
                            client.status === "blocked"
                              ? "w-full rounded-xl border border-emerald-400/30 bg-emerald-500/10 px-4 py-3 text-sm font-semibold text-emerald-300 transition hover:bg-emerald-500/20 disabled:cursor-not-allowed disabled:opacity-50"
                              : "w-full rounded-xl border border-red-400/30 bg-red-500/10 px-4 py-3 text-sm font-semibold text-red-300 transition hover:bg-red-500/20 disabled:cursor-not-allowed disabled:opacity-50"
                          }
                        >
                          {isUpdating
                            ? "Procesando..."
              ...
              <div className="flex flex-col gap-3 border-t border-white/10 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className="rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm font-semibold text-slate-300 transition hover:border-blue-400/30 hover:text-blue-300 disabled:cursor-not-allowed disabled:opacity-40"
                  >
                    Anterior
                  </button>
                  ...
                  <button
                    ...
                    className="rounded-xl border border-blue-400/30 bg-blue-500/10 px-4 py-3 text-sm font-semibold text-blue-300 transition hover:bg-blue-500/20 disabled:cursor-not-allowed disabled:opacity-40"
                  >
                    Siguiente
                  </button>
                </div>
